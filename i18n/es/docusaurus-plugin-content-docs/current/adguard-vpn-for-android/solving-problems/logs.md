...
En la mayoría de los casos, el nivel de registro **Default** es suficiente para rastrear posibles errores. Pero hay casos en los que se requiere información técnica más detallada sobre el dispositivo y las conexiones, por ello nuestro equipo de soporte le pedirá que active el nivel de registro **Extened** o **Extreme** . Para enviar este tipo de registros, siga estos pasos:
...
2. En la sección **Nivel de registro** , seleccione **Extened** o **Extreme** logging level.
